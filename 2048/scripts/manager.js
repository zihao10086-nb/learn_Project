...
Manager.prototype._render = function() {
  // 渲染之前调用存储
  this.storage.setCellState({ score: this.score, grid: this.grid , finalscore:this.finalscore});
  this.render.render(this.grid, { score: this.score, status: this.status ,finalscore:this.finalscore});
};
