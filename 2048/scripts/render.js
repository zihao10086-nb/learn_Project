...
function Render() {
  ...
  this.finalscoreContainer=document.querySelector('.best .value');
  this.statusContainer = document.querySelector('.status');
}

// 渲染整个grid
Render.prototype.render = function(grid, { score, status ,finalscore}) {
  this.empty();
  this.renderScore(score,finalscore);
...
Render.prototype.renderScore = function(score,finalscore) {
  this.scoreContainer.innerHTML = score;
  this.finalscoreContainer.innerHTML = finalscore;
};
